...
class Game {
  constructor(canvas) {
    ...
    //mobile controls
    this.rightMove = document.getElementById("rightBtn");
    this.leftMove = document.getElementById("leftBtn");
    this.fireBtn = document.getElementById("fireBtn");
    this.highScoreResetBtn = document.getElementById("hsResetBtn");
    ...
    this.rightMove.addEventListener("touchstart", (e) => {
      e.preventDefault();
      this.player.speedX = 5;
    });
    this.rightMove.addEventListener("touchend", (e) => {
      console.log("clicked");
      e.preventDefault();
      this.player.speedX = 0;
    });

    this.leftMove.addEventListener("touchstart", (e) => {
      e.preventDefault();
      this.player.speedX = -5;
    });
    this.leftMove.addEventListener("touchend", (e) => {
      console.log("clicked");
      e.preventDefault();
      this.player.speedX = 0;
    });
    ...
    this.highScoreResetBtn.addEventListener("click", (e) => {
      e.preventDefault();
      localStorage.setItem("classicSpaceHighScore", 0);
      location.reload();
    });
  }
  createLaserPool() {
  ...
  loseDisplay() {
    if (this.gameOver) {
      this.restartBtn.classList.add("btnActive");
      this.highScoreResetBtn.classList.add("btnActive");
    }
  }
